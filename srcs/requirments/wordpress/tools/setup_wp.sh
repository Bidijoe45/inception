...
wp core install --path=$WORDPRESS_INSTALLATION_PATH --url="apavel.42.fr" --title="El blog de Apavel" --admin_user=$WP_ADMIN_USER_NAME --admin_password=$WP_ADMIN_USER_PASS --admin_email=$WP_ADMIN_USER_EMAIL --allow-root;
